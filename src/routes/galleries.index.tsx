...
export const Route = createFileRoute("/galleries/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Selected work across portrait, weddings, editorial, travel, and personal black-and-white photography." },
      { property: "og:title", content: "Galleries — Gloria Reina" },
      { property: "og:description", content: "Selected work across portrait, weddings, editorial, travel, and personal black-and-white photography." },
